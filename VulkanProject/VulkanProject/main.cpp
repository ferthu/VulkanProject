...
int main(int argc, const char* argv)
{
	...
	renderer.initialize( new ComputeExperiment(ComputeExperiment::Mode::ASYNC, ComputeExperiment::ShaderMode::MEM_LIMITED, 1024 * 512), 1024, 1024, TRIPLE_BUFFERED); // 256, 256
